...
class Workshop extends React.PureComponent {
    ...
    delete = () => {
        if (confirm(this.props.strings.Delete_workshop_confirmation.replace('%{name}', this.state.name))) {
        ...
        if (this.state.editing){
                ...
                <tr>
                    <td colSpan='4'>
                        <TextInput name="name" value={this.state.name} handleInput={this.handleInput}
                                handleEnter={this.save} errorMessage={this.state.nameError} />
                        { this.props.workshop.completed &&
                            <label className="checkBoxLabel">
                                <input type="checkbox" name="completed" checked={this.state.completed} 
                                        onChange={this.handleCheck} />
                                Completed
                            </label>
                            
                        }
                        <SmallSaveAndCancel handleSave={this.save} handleCancel={this.cancelEdit}
                                    saveInProgress={this.state.saving} strings={this.props.strings} />
                    </td>
                </tr>
            )
        } 
            ...
            return(
                <tr>
                    <td colSpan='4' className="inlineFuzzyDateInputs">
                        <label>{this.props.strings.Workshop_date}:</label><br />

                        <FuzzyDateInput date={this.state.date} handleDateInput={this.handleDateInput}
                            dateIsInvalid={this.dateIsInvalid} showErrors={this.state.showDateErrors}
            ...
            return(
                <tr>
                    ...
                    <td>
                        <DateCell date={this.props.workshop.formattedDate} eventPath={this.props.workshop.eventPath}
                                    newEventPath={this.props.workshop.newEventPath} canUpdate={this.props.workshop.can.update}
                    ...
                    <td>
                        {
                            this.state.completed ? 
                                ...
                                this.props.workshop.can.update &&
                                    <CheckIconButton handleClick={this.completeWorkshop} text={this.props.strings.Mark_completed} />
