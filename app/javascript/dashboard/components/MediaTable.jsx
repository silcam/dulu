...
import { sortActivities, languageSort, stageSort, lastUpdateSort, nameSort } from '../../util/sortFunctions'
...
class MediaTable extends React.PureComponent {
    ...
    changeSort = (sort) => {
        let activities = sortActivities(sort, this.state.activities.slice(), sortFunctions)
        this.setState({
            activities: activities,
            sort: sort
        })
                ...
                <table className='table'>
                    <tbody>
                        {this.state.activities.map((activity) => {
                            return <MediaActivityRow key={activity.id}
                                                    activity={activity}
                                                    strings={strings} />
                        })}
                    </tbody>
