...
class EventsFilterer extends React.PureComponent {
    constructor(props) {
        ...
        domainSelectOptions = domainSelectOptions.concat(Object.values(props.strings.domains).map((domain) => {
    ...
    render() {
        return (
            <div style={{marginBottom: '4px'}}>
                <label>{this.props.strings.Filter}:&nbsp;</label>
                <SelectInput value={this.props.domainFilter}
